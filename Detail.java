...
public class Detail extends AppCompatActivity implements View.OnClickListener{
    ...
    long waterdate;        //물펌프가 작동된 시간
    Date theDatewater;       //물펌프가 작동된 시간
    long leddate;        //led램프가 작동된 시간
    ...
    public class ListItem {
        ...
        public ListItem(String Name, String Humd, String Sunshine,String Waterlevel,String Rwater,String Rlight,String Cdate){
            mData = new String[7];
            mData[0] = Name;
            mData[1] = Humd;
            mData[2] = Sunshine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waterdate = data.getLong("waterdate", 0L);
        theDatewater = new Date(waterdate);
        leddate = data.getLong("leddate", 0L);
        theDateled = new Date(leddate);
        ...
        protected void onPostExecute(String str){       //json 가지고 작업하기
            ...
            try{
                ...
                for(int i=0; i<ja.length(); i++){
                    ...
                    listItem.add(new Detail.ListItem(Name,Humd,Sunshine,Timer,Rwater,Rlight,Cdate));
                }
